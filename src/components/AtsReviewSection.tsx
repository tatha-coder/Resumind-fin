...
export const AtsReviewSection: React.FC<AtsReviewSectionProps> = ({
  ...
  if (!analysis) {
    return (
      <div className="max-w-4xl mx-auto space-y-6 animate-fade-in">
        {/* Empty State Card */}
        <div className="bg-white border border-[#E8E4DC] rounded-2xl p-8 sm:p-12 text-center transition-colors shadow-xs">
          <div className="w-14 h-14 bg-emerald-100/80 text-emerald-700 rounded-2xl flex items-center justify-center mx-auto mb-4">
            <FileCheck className="w-7 h-7" />
          </div>

          <span className="inline-flex items-center space-x-1.5 px-3 py-1 rounded-full text-xs font-semibold bg-emerald-100/90 text-emerald-800 mb-3 border border-emerald-200/80">
          ...
          <p className="text-sm text-[#78716C] max-w-lg mx-auto mt-2 mb-8 leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
            ...
            <button
              ...
              className="w-full sm:w-auto px-6 py-3 bg-[#FAF7F2] hover:bg-[#EAE5DA] text-[#1C1917] text-xs font-semibold rounded-xl transition-colors flex items-center justify-center space-x-2 cursor-pointer border border-[#E8E4DC]"
            >
        ...
        <div className="grid sm:grid-cols-3 gap-4">
          <div className="bg-white border border-[#E8E4DC] rounded-xl p-5 shadow-xs">
            <div className="w-8 h-8 rounded-lg bg-emerald-100/80 text-emerald-700 flex items-center justify-center mb-3">
              <TrendingUp className="w-4 h-4" />
            </div>
            <h3 className="text-sm font-bold text-[#1C1917]">Circular ATS Meter</h3>
          ...
          <div className="bg-white border border-[#E8E4DC] rounded-xl p-5 shadow-xs">
            ...
            <h3 className="text-sm font-bold text-[#1C1917]">Format & Structure</h3>
            <p className="text-xs text-[#78716C] mt-1">
          ...
          <div className="bg-white border border-[#E8E4DC] rounded-xl p-5 shadow-xs">
            ...
            <h3 className="text-sm font-bold text-[#1C1917]">Targeted Improvements</h3>
            <p className="text-xs text-[#78716C] mt-1">
  ...
  const getScoreStatus = (val: number) => {
    if (val >= 85) return { color: '#2E8B57', label: 'Strong ATS Pass', desc: 'Optimal for automated screening' };
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6 animate-fade-in">
      ...
      <div className="bg-white border border-[#E8E4DC] rounded-2xl p-6 sm:p-8 transition-colors shadow-xs">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
          
          {/* Left: Score Breakdown Info */}
          <div className="space-y-3 text-center lg:text-left flex-1">
            <div className="inline-flex items-center space-x-2 px-3 py-1 rounded-full text-xs font-semibold bg-emerald-100/90 text-emerald-800 border border-emerald-200/80">
            ...
            <p className="text-sm text-[#44403C] leading-relaxed max-w-xl">
            ...
            <div className="pt-2 flex flex-wrap items-center justify-center lg:justify-start gap-4">
              <div className="flex items-center space-x-2 text-xs font-medium text-[#78716C]">
                ...
                <span>Format Compatibility: <strong className="text-[#1C1917] font-semibold">{analysis.formattingScore}%</strong></span>
              </div>
              <div className="flex items-center space-x-2 text-xs font-medium text-[#78716C]">
                <span className="w-2.5 h-2.5 rounded-full bg-teal-600" />
                <span>Keyword Density: <strong className="text-[#1C1917] font-semibold">{analysis.keywordScore}%</strong></span>
              </div>
              <div className="flex items-center space-x-2 text-xs font-medium text-[#78716C]">
                <span className="w-2.5 h-2.5 rounded-full bg-amber-600" />
                <span>Content Quantification: <strong className="text-[#1C1917] font-semibold">{analysis.impactScore}%</strong></span>
              </div>
            </div>
          </div>
          ...
          <div className="relative flex flex-col items-center justify-center shrink-0 p-4">
            <div className="relative w-44 h-44 flex items-center justify-center">
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center text-center pointer-events-none">
                <span className="text-4xl font-extrabold text-[#1C1917] tracking-tight">
                  {score}
                </span>
      ...
      <div className="bg-white border border-[#E8E4DC] rounded-2xl p-6 transition-colors shadow-xs space-y-5">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-[#E8E4DC] pb-3.5">
          <div>
            <div className="flex items-center space-x-2">
              <div className="w-7 h-7 rounded-lg bg-emerald-100/80 text-emerald-700 flex items-center justify-center font-bold">
                <TrendingUp className="w-4 h-4" />
              </div>
          ...
          <div className="flex items-center space-x-2">
            <span className="text-xs text-[#78716C]">Score:</span>
            <span className="px-2.5 py-0.5 rounded-md text-xs font-bold bg-emerald-100/90 text-emerald-800 border border-emerald-200/80">
        ...
        <div className="grid md:grid-cols-3 gap-4">
          {/* Technical Skills */}
          <div className="bg-[#FAF7F2] border border-[#E8E4DC] rounded-xl p-4 space-y-2.5">
            ...
            <div className="flex flex-wrap gap-1.5 pt-1">
              {analysis.detectedSkills?.technical?.length ? (
                analysis.detectedSkills.technical.map((tech, idx) => (
                  <span
                    key={idx}
                    className="px-2 py-0.5 rounded-md text-xs font-medium bg-white border border-[#E8E4DC] text-[#1C1917] shadow-2xs"
                  >
                    {tech}
                  </span>
                ))
              ) : (
                <span className="text-xs text-[#78716C] italic">No specific technical keywords detected.</span>
              )}
            </div>
          </div>
          ...
          <div className="bg-[#FAF7F2] border border-[#E8E4DC] rounded-xl p-4 space-y-2.5">
            ...
            <div className="flex flex-wrap gap-1.5 pt-1">
              {analysis.detectedSkills?.toolsAndFrameworks?.length ? (
                ...
                <span className="text-xs text-[#78716C] italic">No frameworks recognized.</span>
              )}
            </div>
          </div>
          ...
          <div className="bg-[#FAF7F2] border border-[#E8E4DC] rounded-xl p-4 space-y-2.5">
            ...
            <div className="flex flex-wrap gap-1.5 pt-1">
              {analysis.detectedSkills?.soft?.length ? (
                ...
                <span className="text-xs text-[#78716C] italic">No soft skills parsed.</span>
              )}
            </div>
          </div>
        </div>
      ...
      <div className="bg-white border border-[#E8E4DC] rounded-2xl p-6 transition-colors shadow-xs space-y-5">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-[#E8E4DC] pb-3.5">
          <div>
            <div className="flex items-center space-x-2">
              <div className="w-7 h-7 rounded-lg bg-emerald-50 border border-emerald-200/90 text-emerald-700 flex items-center justify-center font-bold">
                <Layout className="w-4 h-4" />
              </div>
              <h3 className="text-base font-bold text-[#1C1917]">
          ...
          <div className="flex items-center space-x-2">
            <span className="text-xs text-[#78716C]">Score:</span>
            <span className="px-2.5 py-0.5 rounded-md text-xs font-bold bg-emerald-50 text-emerald-800 border border-emerald-200/80">
      ...
      <div className="bg-white border border-[#E8E4DC] rounded-2xl p-6 transition-colors shadow-xs space-y-5">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-[#E8E4DC] pb-3.5">
          <div>
            <div className="flex items-center space-x-2">
              <div className="w-7 h-7 rounded-lg bg-[#FAF7F2] text-[#1C1917] border border-[#E8E4DC] flex items-center justify-center font-bold">
        ...
        <div className="space-y-3">
          {analysis.sections.map((sec, idx) => {
            ...
            return (
              <div 
                key={idx}
                className="bg-[#FAF7F2] border border-[#E8E4DC] rounded-xl p-4 flex flex-col sm:flex-row sm:items-center justify-between gap-3 hover:border-emerald-300 transition-colors"
              >
                <div className="space-y-1">
                  <div className="flex items-center space-x-2">
                    <span className="text-xs font-bold text-[#1C1917]">
                ...
                <div className="flex items-center space-x-3 shrink-0">
                  <div className="w-24 bg-stone-200 h-2 rounded-full overflow-hidden">
                    <div 
                      className={`h-full rounded-full ${isGood ? 'bg-emerald-600' : isWarning ? 'bg-amber-600' : 'bg-rose-500'}`}
                      style={{ width: `${sec.score}%` }}
                    />
                  </div>
                  <span className="text-xs font-bold font-mono text-[#1C1917] w-9 text-right">
                    {sec.score}%
                  </span>
                </div>
              </div>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        {/* WHAT'S WORKING */}
        <div className="bg-white border border-[#E8E4DC] rounded-2xl p-6 transition-colors shadow-xs space-y-4">
          <div className="flex items-center space-x-2.5 border-b border-[#E8E4DC] pb-3">
            <div className="w-8 h-8 rounded-lg bg-emerald-50 border border-emerald-200/90 text-emerald-700 flex items-center justify-center font-bold">
          ...
          <div className="space-y-2.5">
            {analysis.keyStrengths.map((str, idx) => (
              <div key={idx} className="flex items-start space-x-2.5 p-3 rounded-lg bg-[#FAF7F2] border border-[#E8E4DC] text-xs">
                <Check className="w-4 h-4 text-emerald-700 shrink-0 mt-0.5" />
                <span className="text-[#44403C] font-medium leading-relaxed">
                  {str}
                </span>
              </div>
            ))}
            ...
            {passedChecks.slice(0, 2).map((chk, idx) => (
              <div key={`p-${idx}`} className="flex items-start space-x-2.5 p-3 rounded-lg bg-emerald-50/50 border border-emerald-200/90 text-xs">
                <CheckCircle className="w-4 h-4 text-emerald-700 shrink-0 mt-0.5" />
                <div>
                  <strong className="text-[#1C1917] font-semibold">{chk.category}:</strong>{' '}
                  <span className="text-[#44403C]">{chk.detail}</span>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="bg-white border border-[#E8E4DC] rounded-2xl p-6 transition-colors shadow-xs space-y-4">
          ...
          <div className="space-y-2.5">
            {analysis.criticalGaps.map((gap, idx) => (
              <div key={idx} className="flex items-start space-x-2.5 p-3 rounded-lg bg-amber-50/40 border border-amber-200 text-xs">
            ...
            {analysis.actionableNextSteps.slice(0, 3).map((step, idx) => (
              <div key={`step-${idx}`} className="flex items-start space-x-2.5 p-3 rounded-lg bg-[#FAF7F2] border border-[#E8E4DC] text-xs">
